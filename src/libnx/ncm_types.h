...
typedef enum
{
    ...
    NcmContentMetaAttribute_IncludesExFatDriver = (1U << (0)), ///< IncludesExFatDriver
    NcmContentMetaAttribute_Rebootless = (1U << (1)), ///< Rebootless
    NcmContentMetaAttribute_Compacted = (1U << (2)), ///< Compacted
 ...
 */
constexpr void ncmContentInfoSizeToU64(const NcmContentInfo* info, u64* out) {
 ...
 */
constexpr void ncmU64ToContentInfoSize(const u64 size, NcmContentInfo* info) {
